(function () {
                    ...
                    if (container.length) {
                        ...
                        folders.forEach(function(folder, i) {
                            ...
                            tile.on('click', function() {
                                // ✅ ВИПРАВЛЕНО: Використовуємо items для масиву карток
                                Lampa.Activity.push({
                                    title: folder.name,
    ...
    // 2. ДОДАВАННЯ В ПАПКИ З КАРТКИ ФІЛЬМУ
            ...
            if (folders.length > 0 && movie) {
                ...
                params.onSelect = function (item) {
                    if (item.is_custom) {
                        ...
                        // ✅ Зберігаємо повний об'єкт картки для коректного рендеру
